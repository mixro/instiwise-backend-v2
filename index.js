...
// Middleware
app.use(helmet());
const allowedOrigins = ['http://localhost:8081', 'http://localhost:5173', 'http://localhost:5174', 'https://instiwise-landing.netlify.app', 'https://instiwise-app-admin.netlify.app'];
app.use(
  cors({
